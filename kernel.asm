...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 7d 56 10 80 	movl   $0x8010567d,0x14(%eax)
  p->context = (struct context*)sp;
...
80103823:	e8 28 34 00 00       	call   80106c50 <setupkvm>
...
80103841:	e8 ea 30 00 00       	call   80106930 <inituvm>
...
8010392c:	e8 ef 2e 00 00       	call   80106820 <switchuvm>
  return 0;
...
8010394a:	e8 21 31 00 00       	call   80106a70 <allocuvm>
...
8010396a:	e8 31 32 00 00       	call   80106ba0 <deallocuvm>
...
801039b8:	e8 63 33 00 00       	call   80106d20 <copyuvm>
...
80103af0:	e8 2b 2d 00 00       	call   80106820 <switchuvm>
...
80103b02:	e8 a4 0b 00 00       	call   801046ab <swtch>
      switchkvm();
80103b07:	e8 f4 2c 00 00       	call   80106800 <switchkvm>
      c->proc = 0;
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 f2 2c 00 00       	call   80106bd0 <freevm>
        release(&ptable.lock);
...
80105650 <sys_ticketLockInit>:

int sys_ticketLockInit(void){
80105650:	55                   	push   %ebp
80105651:	89 e5                	mov    %esp,%ebp
80105653:	eb fe                	jmp    80105653 <sys_ticketLockInit+0x3>
80105655:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105659:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105660 <sys_ticketLockTest>:
    return sys_ticketLockInit();
}

int sys_ticketLockTest(void){
80105660:	55                   	push   %ebp
80105661:	89 e5                	mov    %esp,%ebp
80105663:	eb fe                	jmp    80105663 <sys_ticketLockTest+0x3>
...
80105666:	06                   	push   %es
  pushl %fs
80105667:	0f a0                	push   %fs
  pushl %gs
80105669:	0f a8                	push   %gs
  pushal
8010566b:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010566c:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105670:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105672:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105674:	54                   	push   %esp
  call trap
80105675:	e8 c6 00 00 00       	call   80105740 <trap>
  addl $4, %esp
8010567a:	83 c4 04             	add    $0x4,%esp
...
8010567d:	61                   	popa   
  popl %gs
8010567e:	0f a9                	pop    %gs
  popl %fs
80105680:	0f a1                	pop    %fs
  popl %es
80105682:	07                   	pop    %es
  popl %ds
80105683:	1f                   	pop    %ds
...
801056de:	00 00 ef 
  initlock(&tickslock, "time");
801056e1:	68 a1 76 10 80       	push   $0x801076a1
...
801056f4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801056fa:	e8 21 eb ff ff       	call   80104220 <initlock>
}
...
80105760:	ff 24 85 48 77 10 80 	jmp    *-0x7fef88b8(,%eax,4)
...
80105770:	e8 6b e0 ff ff       	call   801037e0 <myproc>
...
80105790:	e8 2b e0 ff ff       	call   801037c0 <cpuid>
...
801057a1:	e8 3a e0 ff ff       	call   801037e0 <myproc>
801057a6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801057a9:	e8 32 e0 ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801057c5:	68 04 77 10 80       	push   $0x80107704
801057ca:	e8 91 ae ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057cf:	83 c4 20             	add    $0x20,%esp
801057d2:	e8 09 e0 ff ff       	call   801037e0 <myproc>
...
801057de:	e8 fd df ff ff       	call   801037e0 <myproc>
801057e3:	85 c0                	test   %eax,%eax
801057e5:	74 1d                	je     80105804 <trap+0xc4>
801057e7:	e8 f4 df ff ff       	call   801037e0 <myproc>
...
80105804:	e8 d7 df ff ff       	call   801037e0 <myproc>
80105809:	85 c0                	test   %eax,%eax
8010580b:	74 0b                	je     80105818 <trap+0xd8>
8010580d:	e8 ce df ff ff       	call   801037e0 <myproc>
...
80105821:	e8 ba df ff ff       	call   801037e0 <myproc>
...
8010585d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105860:	e8 fb ef ff ff       	call   80104860 <syscall>
    if(myproc()->killed)
...
801058ff:	e8 bc de ff ff       	call   801037c0 <cpuid>
80105904:	56                   	push   %esi
80105905:	53                   	push   %ebx
80105906:	50                   	push   %eax
80105907:	68 ac 76 10 80       	push   $0x801076ac
...
801059a5:	68 d0 76 10 80       	push   $0x801076d0
801059aa:	e8 b1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059af:	83 c4 14             	add    $0x14,%esp
801059b2:	68 a6 76 10 80       	push   $0x801076a6
...
80105aac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105aaf:	bb c8 77 10 80       	mov    $0x801077c8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b47:	6a 00                	push   $0x0
  jmp alltraps
80105b49:	e9 17 fb ff ff       	jmp    80105665 <alltraps>
...
80105b50:	6a 01                	push   $0x1
  jmp alltraps
80105b52:	e9 0e fb ff ff       	jmp    80105665 <alltraps>
...
80105b59:	6a 02                	push   $0x2
  jmp alltraps
80105b5b:	e9 05 fb ff ff       	jmp    80105665 <alltraps>
...
80105b62:	6a 03                	push   $0x3
  jmp alltraps
80105b64:	e9 fc fa ff ff       	jmp    80105665 <alltraps>
...
80105b6b:	6a 04                	push   $0x4
  jmp alltraps
80105b6d:	e9 f3 fa ff ff       	jmp    80105665 <alltraps>
...
80105b74:	6a 05                	push   $0x5
  jmp alltraps
80105b76:	e9 ea fa ff ff       	jmp    80105665 <alltraps>
...
80105b7d:	6a 06                	push   $0x6
  jmp alltraps
80105b7f:	e9 e1 fa ff ff       	jmp    80105665 <alltraps>
...
80105b86:	6a 07                	push   $0x7
  jmp alltraps
80105b88:	e9 d8 fa ff ff       	jmp    80105665 <alltraps>
...
80105b8d:	6a 08                	push   $0x8
  jmp alltraps
80105b8f:	e9 d1 fa ff ff       	jmp    80105665 <alltraps>
...
80105b96:	6a 09                	push   $0x9
  jmp alltraps
80105b98:	e9 c8 fa ff ff       	jmp    80105665 <alltraps>
...
80105b9d:	6a 0a                	push   $0xa
  jmp alltraps
80105b9f:	e9 c1 fa ff ff       	jmp    80105665 <alltraps>
...
80105ba4:	6a 0b                	push   $0xb
  jmp alltraps
80105ba6:	e9 ba fa ff ff       	jmp    80105665 <alltraps>
...
80105bab:	6a 0c                	push   $0xc
  jmp alltraps
80105bad:	e9 b3 fa ff ff       	jmp    80105665 <alltraps>
...
80105bb2:	6a 0d                	push   $0xd
  jmp alltraps
80105bb4:	e9 ac fa ff ff       	jmp    80105665 <alltraps>
...
80105bb9:	6a 0e                	push   $0xe
  jmp alltraps
80105bbb:	e9 a5 fa ff ff       	jmp    80105665 <alltraps>
...
80105bc2:	6a 0f                	push   $0xf
  jmp alltraps
80105bc4:	e9 9c fa ff ff       	jmp    80105665 <alltraps>
...
80105bcb:	6a 10                	push   $0x10
  jmp alltraps
80105bcd:	e9 93 fa ff ff       	jmp    80105665 <alltraps>
...
80105bd2:	6a 11                	push   $0x11
  jmp alltraps
80105bd4:	e9 8c fa ff ff       	jmp    80105665 <alltraps>
...
80105bdb:	6a 12                	push   $0x12
  jmp alltraps
80105bdd:	e9 83 fa ff ff       	jmp    80105665 <alltraps>
...
80105be4:	6a 13                	push   $0x13
  jmp alltraps
80105be6:	e9 7a fa ff ff       	jmp    80105665 <alltraps>
...
80105bed:	6a 14                	push   $0x14
  jmp alltraps
80105bef:	e9 71 fa ff ff       	jmp    80105665 <alltraps>
...
80105bf6:	6a 15                	push   $0x15
  jmp alltraps
80105bf8:	e9 68 fa ff ff       	jmp    80105665 <alltraps>
...
80105bff:	6a 16                	push   $0x16
  jmp alltraps
80105c01:	e9 5f fa ff ff       	jmp    80105665 <alltraps>
...
80105c08:	6a 17                	push   $0x17
  jmp alltraps
80105c0a:	e9 56 fa ff ff       	jmp    80105665 <alltraps>
...
80105c11:	6a 18                	push   $0x18
  jmp alltraps
80105c13:	e9 4d fa ff ff       	jmp    80105665 <alltraps>
...
80105c1a:	6a 19                	push   $0x19
  jmp alltraps
80105c1c:	e9 44 fa ff ff       	jmp    80105665 <alltraps>
...
80105c23:	6a 1a                	push   $0x1a
  jmp alltraps
80105c25:	e9 3b fa ff ff       	jmp    80105665 <alltraps>
...
80105c2c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c2e:	e9 32 fa ff ff       	jmp    80105665 <alltraps>
...
80105c35:	6a 1c                	push   $0x1c
  jmp alltraps
80105c37:	e9 29 fa ff ff       	jmp    80105665 <alltraps>
...
80105c3e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c40:	e9 20 fa ff ff       	jmp    80105665 <alltraps>
...
80105c47:	6a 1e                	push   $0x1e
  jmp alltraps
80105c49:	e9 17 fa ff ff       	jmp    80105665 <alltraps>
...
80105c50:	6a 1f                	push   $0x1f
  jmp alltraps
80105c52:	e9 0e fa ff ff       	jmp    80105665 <alltraps>
...
80105c59:	6a 20                	push   $0x20
  jmp alltraps
80105c5b:	e9 05 fa ff ff       	jmp    80105665 <alltraps>
...
80105c62:	6a 21                	push   $0x21
  jmp alltraps
80105c64:	e9 fc f9 ff ff       	jmp    80105665 <alltraps>
...
80105c6b:	6a 22                	push   $0x22
  jmp alltraps
80105c6d:	e9 f3 f9 ff ff       	jmp    80105665 <alltraps>
...
80105c74:	6a 23                	push   $0x23
  jmp alltraps
80105c76:	e9 ea f9 ff ff       	jmp    80105665 <alltraps>
...
80105c7d:	6a 24                	push   $0x24
  jmp alltraps
80105c7f:	e9 e1 f9 ff ff       	jmp    80105665 <alltraps>
...
80105c86:	6a 25                	push   $0x25
  jmp alltraps
80105c88:	e9 d8 f9 ff ff       	jmp    80105665 <alltraps>
...
80105c8f:	6a 26                	push   $0x26
  jmp alltraps
80105c91:	e9 cf f9 ff ff       	jmp    80105665 <alltraps>
...
80105c98:	6a 27                	push   $0x27
  jmp alltraps
80105c9a:	e9 c6 f9 ff ff       	jmp    80105665 <alltraps>
...
80105ca1:	6a 28                	push   $0x28
  jmp alltraps
80105ca3:	e9 bd f9 ff ff       	jmp    80105665 <alltraps>
...
80105caa:	6a 29                	push   $0x29
  jmp alltraps
80105cac:	e9 b4 f9 ff ff       	jmp    80105665 <alltraps>
...
80105cb3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cb5:	e9 ab f9 ff ff       	jmp    80105665 <alltraps>
...
80105cbc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cbe:	e9 a2 f9 ff ff       	jmp    80105665 <alltraps>
...
80105cc5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cc7:	e9 99 f9 ff ff       	jmp    80105665 <alltraps>
...
80105cce:	6a 2d                	push   $0x2d
  jmp alltraps
80105cd0:	e9 90 f9 ff ff       	jmp    80105665 <alltraps>
...
80105cd7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cd9:	e9 87 f9 ff ff       	jmp    80105665 <alltraps>
...
80105ce0:	6a 2f                	push   $0x2f
  jmp alltraps
80105ce2:	e9 7e f9 ff ff       	jmp    80105665 <alltraps>
...
80105ce9:	6a 30                	push   $0x30
  jmp alltraps
80105ceb:	e9 75 f9 ff ff       	jmp    80105665 <alltraps>
...
80105cf2:	6a 31                	push   $0x31
  jmp alltraps
80105cf4:	e9 6c f9 ff ff       	jmp    80105665 <alltraps>
...
80105cfb:	6a 32                	push   $0x32
  jmp alltraps
80105cfd:	e9 63 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d04:	6a 33                	push   $0x33
  jmp alltraps
80105d06:	e9 5a f9 ff ff       	jmp    80105665 <alltraps>
...
80105d0d:	6a 34                	push   $0x34
  jmp alltraps
80105d0f:	e9 51 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d16:	6a 35                	push   $0x35
  jmp alltraps
80105d18:	e9 48 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d1f:	6a 36                	push   $0x36
  jmp alltraps
80105d21:	e9 3f f9 ff ff       	jmp    80105665 <alltraps>
...
80105d28:	6a 37                	push   $0x37
  jmp alltraps
80105d2a:	e9 36 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d31:	6a 38                	push   $0x38
  jmp alltraps
80105d33:	e9 2d f9 ff ff       	jmp    80105665 <alltraps>
...
80105d3a:	6a 39                	push   $0x39
  jmp alltraps
80105d3c:	e9 24 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d43:	6a 3a                	push   $0x3a
  jmp alltraps
80105d45:	e9 1b f9 ff ff       	jmp    80105665 <alltraps>
...
80105d4c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d4e:	e9 12 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d55:	6a 3c                	push   $0x3c
  jmp alltraps
80105d57:	e9 09 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d5e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d60:	e9 00 f9 ff ff       	jmp    80105665 <alltraps>
...
80105d67:	6a 3e                	push   $0x3e
  jmp alltraps
80105d69:	e9 f7 f8 ff ff       	jmp    80105665 <alltraps>
...
80105d70:	6a 3f                	push   $0x3f
  jmp alltraps
80105d72:	e9 ee f8 ff ff       	jmp    80105665 <alltraps>
...
80105d79:	6a 40                	push   $0x40
  jmp alltraps
80105d7b:	e9 e5 f8 ff ff       	jmp    80105665 <alltraps>
...
80105d82:	6a 41                	push   $0x41
  jmp alltraps
80105d84:	e9 dc f8 ff ff       	jmp    80105665 <alltraps>
...
80105d8b:	6a 42                	push   $0x42
  jmp alltraps
80105d8d:	e9 d3 f8 ff ff       	jmp    80105665 <alltraps>
...
80105d94:	6a 43                	push   $0x43
  jmp alltraps
80105d96:	e9 ca f8 ff ff       	jmp    80105665 <alltraps>
...
80105d9d:	6a 44                	push   $0x44
  jmp alltraps
80105d9f:	e9 c1 f8 ff ff       	jmp    80105665 <alltraps>
...
80105da6:	6a 45                	push   $0x45
  jmp alltraps
80105da8:	e9 b8 f8 ff ff       	jmp    80105665 <alltraps>
...
80105daf:	6a 46                	push   $0x46
  jmp alltraps
80105db1:	e9 af f8 ff ff       	jmp    80105665 <alltraps>
...
80105db8:	6a 47                	push   $0x47
  jmp alltraps
80105dba:	e9 a6 f8 ff ff       	jmp    80105665 <alltraps>
...
80105dc1:	6a 48                	push   $0x48
  jmp alltraps
80105dc3:	e9 9d f8 ff ff       	jmp    80105665 <alltraps>
...
80105dca:	6a 49                	push   $0x49
  jmp alltraps
80105dcc:	e9 94 f8 ff ff       	jmp    80105665 <alltraps>
...
80105dd3:	6a 4a                	push   $0x4a
  jmp alltraps
80105dd5:	e9 8b f8 ff ff       	jmp    80105665 <alltraps>
...
80105ddc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dde:	e9 82 f8 ff ff       	jmp    80105665 <alltraps>
...
80105de5:	6a 4c                	push   $0x4c
  jmp alltraps
80105de7:	e9 79 f8 ff ff       	jmp    80105665 <alltraps>
...
80105dee:	6a 4d                	push   $0x4d
  jmp alltraps
80105df0:	e9 70 f8 ff ff       	jmp    80105665 <alltraps>
...
80105df7:	6a 4e                	push   $0x4e
  jmp alltraps
80105df9:	e9 67 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e00:	6a 4f                	push   $0x4f
  jmp alltraps
80105e02:	e9 5e f8 ff ff       	jmp    80105665 <alltraps>
...
80105e09:	6a 50                	push   $0x50
  jmp alltraps
80105e0b:	e9 55 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e12:	6a 51                	push   $0x51
  jmp alltraps
80105e14:	e9 4c f8 ff ff       	jmp    80105665 <alltraps>
...
80105e1b:	6a 52                	push   $0x52
  jmp alltraps
80105e1d:	e9 43 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e24:	6a 53                	push   $0x53
  jmp alltraps
80105e26:	e9 3a f8 ff ff       	jmp    80105665 <alltraps>
...
80105e2d:	6a 54                	push   $0x54
  jmp alltraps
80105e2f:	e9 31 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e36:	6a 55                	push   $0x55
  jmp alltraps
80105e38:	e9 28 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e3f:	6a 56                	push   $0x56
  jmp alltraps
80105e41:	e9 1f f8 ff ff       	jmp    80105665 <alltraps>
...
80105e48:	6a 57                	push   $0x57
  jmp alltraps
80105e4a:	e9 16 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e51:	6a 58                	push   $0x58
  jmp alltraps
80105e53:	e9 0d f8 ff ff       	jmp    80105665 <alltraps>
...
80105e5a:	6a 59                	push   $0x59
  jmp alltraps
80105e5c:	e9 04 f8 ff ff       	jmp    80105665 <alltraps>
...
80105e63:	6a 5a                	push   $0x5a
  jmp alltraps
80105e65:	e9 fb f7 ff ff       	jmp    80105665 <alltraps>
...
80105e6c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e6e:	e9 f2 f7 ff ff       	jmp    80105665 <alltraps>
...
80105e75:	6a 5c                	push   $0x5c
  jmp alltraps
80105e77:	e9 e9 f7 ff ff       	jmp    80105665 <alltraps>
...
80105e7e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e80:	e9 e0 f7 ff ff       	jmp    80105665 <alltraps>
...
80105e87:	6a 5e                	push   $0x5e
  jmp alltraps
80105e89:	e9 d7 f7 ff ff       	jmp    80105665 <alltraps>
...
80105e90:	6a 5f                	push   $0x5f
  jmp alltraps
80105e92:	e9 ce f7 ff ff       	jmp    80105665 <alltraps>
...
80105e99:	6a 60                	push   $0x60
  jmp alltraps
80105e9b:	e9 c5 f7 ff ff       	jmp    80105665 <alltraps>
...
80105ea2:	6a 61                	push   $0x61
  jmp alltraps
80105ea4:	e9 bc f7 ff ff       	jmp    80105665 <alltraps>
...
80105eab:	6a 62                	push   $0x62
  jmp alltraps
80105ead:	e9 b3 f7 ff ff       	jmp    80105665 <alltraps>
...
80105eb4:	6a 63                	push   $0x63
  jmp alltraps
80105eb6:	e9 aa f7 ff ff       	jmp    80105665 <alltraps>
...
80105ebd:	6a 64                	push   $0x64
  jmp alltraps
80105ebf:	e9 a1 f7 ff ff       	jmp    80105665 <alltraps>
...
80105ec6:	6a 65                	push   $0x65
  jmp alltraps
80105ec8:	e9 98 f7 ff ff       	jmp    80105665 <alltraps>
...
80105ecf:	6a 66                	push   $0x66
  jmp alltraps
80105ed1:	e9 8f f7 ff ff       	jmp    80105665 <alltraps>
...
80105ed8:	6a 67                	push   $0x67
  jmp alltraps
80105eda:	e9 86 f7 ff ff       	jmp    80105665 <alltraps>
...
80105ee1:	6a 68                	push   $0x68
  jmp alltraps
80105ee3:	e9 7d f7 ff ff       	jmp    80105665 <alltraps>
...
80105eea:	6a 69                	push   $0x69
  jmp alltraps
80105eec:	e9 74 f7 ff ff       	jmp    80105665 <alltraps>
...
80105ef3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ef5:	e9 6b f7 ff ff       	jmp    80105665 <alltraps>
...
80105efc:	6a 6b                	push   $0x6b
  jmp alltraps
80105efe:	e9 62 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f05:	6a 6c                	push   $0x6c
  jmp alltraps
80105f07:	e9 59 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f0e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f10:	e9 50 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f17:	6a 6e                	push   $0x6e
  jmp alltraps
80105f19:	e9 47 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f20:	6a 6f                	push   $0x6f
  jmp alltraps
80105f22:	e9 3e f7 ff ff       	jmp    80105665 <alltraps>
...
80105f29:	6a 70                	push   $0x70
  jmp alltraps
80105f2b:	e9 35 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f32:	6a 71                	push   $0x71
  jmp alltraps
80105f34:	e9 2c f7 ff ff       	jmp    80105665 <alltraps>
...
80105f3b:	6a 72                	push   $0x72
  jmp alltraps
80105f3d:	e9 23 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f44:	6a 73                	push   $0x73
  jmp alltraps
80105f46:	e9 1a f7 ff ff       	jmp    80105665 <alltraps>
...
80105f4d:	6a 74                	push   $0x74
  jmp alltraps
80105f4f:	e9 11 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f56:	6a 75                	push   $0x75
  jmp alltraps
80105f58:	e9 08 f7 ff ff       	jmp    80105665 <alltraps>
...
80105f5f:	6a 76                	push   $0x76
  jmp alltraps
80105f61:	e9 ff f6 ff ff       	jmp    80105665 <alltraps>
...
80105f68:	6a 77                	push   $0x77
  jmp alltraps
80105f6a:	e9 f6 f6 ff ff       	jmp    80105665 <alltraps>
...
80105f71:	6a 78                	push   $0x78
  jmp alltraps
80105f73:	e9 ed f6 ff ff       	jmp    80105665 <alltraps>
...
80105f7a:	6a 79                	push   $0x79
  jmp alltraps
80105f7c:	e9 e4 f6 ff ff       	jmp    80105665 <alltraps>
...
80105f83:	6a 7a                	push   $0x7a
  jmp alltraps
80105f85:	e9 db f6 ff ff       	jmp    80105665 <alltraps>
...
80105f8c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f8e:	e9 d2 f6 ff ff       	jmp    80105665 <alltraps>
...
80105f95:	6a 7c                	push   $0x7c
  jmp alltraps
80105f97:	e9 c9 f6 ff ff       	jmp    80105665 <alltraps>
...
80105f9e:	6a 7d                	push   $0x7d
  jmp alltraps
80105fa0:	e9 c0 f6 ff ff       	jmp    80105665 <alltraps>
...
80105fa7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fa9:	e9 b7 f6 ff ff       	jmp    80105665 <alltraps>
...
80105fb0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fb2:	e9 ae f6 ff ff       	jmp    80105665 <alltraps>
...
80105fb9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fbe:	e9 a2 f6 ff ff       	jmp    80105665 <alltraps>
...
80105fc5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fca:	e9 96 f6 ff ff       	jmp    80105665 <alltraps>
...
80105fd1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fd6:	e9 8a f6 ff ff       	jmp    80105665 <alltraps>
...
80105fdd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fe2:	e9 7e f6 ff ff       	jmp    80105665 <alltraps>
...
80105fe9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fee:	e9 72 f6 ff ff       	jmp    80105665 <alltraps>
...
80105ff5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105ffa:	e9 66 f6 ff ff       	jmp    80105665 <alltraps>
...
80106001:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106006:	e9 5a f6 ff ff       	jmp    80105665 <alltraps>
...
8010600d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106012:	e9 4e f6 ff ff       	jmp    80105665 <alltraps>
...
80106019:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010601e:	e9 42 f6 ff ff       	jmp    80105665 <alltraps>
...
80106025:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010602a:	e9 36 f6 ff ff       	jmp    80105665 <alltraps>
...
80106031:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106036:	e9 2a f6 ff ff       	jmp    80105665 <alltraps>
...
8010603d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106042:	e9 1e f6 ff ff       	jmp    80105665 <alltraps>
...
80106049:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010604e:	e9 12 f6 ff ff       	jmp    80105665 <alltraps>
...
80106055:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010605a:	e9 06 f6 ff ff       	jmp    80105665 <alltraps>
...
80106061:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106066:	e9 fa f5 ff ff       	jmp    80105665 <alltraps>
...
8010606d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106072:	e9 ee f5 ff ff       	jmp    80105665 <alltraps>
...
80106079:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010607e:	e9 e2 f5 ff ff       	jmp    80105665 <alltraps>
...
80106085:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010608a:	e9 d6 f5 ff ff       	jmp    80105665 <alltraps>
...
80106091:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106096:	e9 ca f5 ff ff       	jmp    80105665 <alltraps>
...
8010609d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060a2:	e9 be f5 ff ff       	jmp    80105665 <alltraps>
...
801060a9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060ae:	e9 b2 f5 ff ff       	jmp    80105665 <alltraps>
...
801060b5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060ba:	e9 a6 f5 ff ff       	jmp    80105665 <alltraps>
...
801060c1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060c6:	e9 9a f5 ff ff       	jmp    80105665 <alltraps>
...
801060cd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060d2:	e9 8e f5 ff ff       	jmp    80105665 <alltraps>
...
801060d9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060de:	e9 82 f5 ff ff       	jmp    80105665 <alltraps>
...
801060e5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060ea:	e9 76 f5 ff ff       	jmp    80105665 <alltraps>
...
801060f1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060f6:	e9 6a f5 ff ff       	jmp    80105665 <alltraps>
...
801060fd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106102:	e9 5e f5 ff ff       	jmp    80105665 <alltraps>
...
80106109:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010610e:	e9 52 f5 ff ff       	jmp    80105665 <alltraps>
...
80106115:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010611a:	e9 46 f5 ff ff       	jmp    80105665 <alltraps>
...
80106121:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106126:	e9 3a f5 ff ff       	jmp    80105665 <alltraps>
...
8010612d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106132:	e9 2e f5 ff ff       	jmp    80105665 <alltraps>
...
80106139:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010613e:	e9 22 f5 ff ff       	jmp    80105665 <alltraps>
...
80106145:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010614a:	e9 16 f5 ff ff       	jmp    80105665 <alltraps>
...
80106151:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106156:	e9 0a f5 ff ff       	jmp    80105665 <alltraps>
...
8010615d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106162:	e9 fe f4 ff ff       	jmp    80105665 <alltraps>
...
80106169:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010616e:	e9 f2 f4 ff ff       	jmp    80105665 <alltraps>
...
80106175:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010617a:	e9 e6 f4 ff ff       	jmp    80105665 <alltraps>
...
80106181:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106186:	e9 da f4 ff ff       	jmp    80105665 <alltraps>
...
8010618d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106192:	e9 ce f4 ff ff       	jmp    80105665 <alltraps>
...
80106199:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010619e:	e9 c2 f4 ff ff       	jmp    80105665 <alltraps>
...
801061a5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061aa:	e9 b6 f4 ff ff       	jmp    80105665 <alltraps>
...
801061b1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061b6:	e9 aa f4 ff ff       	jmp    80105665 <alltraps>
...
801061bd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061c2:	e9 9e f4 ff ff       	jmp    80105665 <alltraps>
...
801061c9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061ce:	e9 92 f4 ff ff       	jmp    80105665 <alltraps>
...
801061d5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061da:	e9 86 f4 ff ff       	jmp    80105665 <alltraps>
...
801061e1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061e6:	e9 7a f4 ff ff       	jmp    80105665 <alltraps>
...
801061ed:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061f2:	e9 6e f4 ff ff       	jmp    80105665 <alltraps>
...
801061f9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061fe:	e9 62 f4 ff ff       	jmp    80105665 <alltraps>
...
80106205:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010620a:	e9 56 f4 ff ff       	jmp    80105665 <alltraps>
...
80106211:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106216:	e9 4a f4 ff ff       	jmp    80105665 <alltraps>
...
8010621d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106222:	e9 3e f4 ff ff       	jmp    80105665 <alltraps>
...
80106229:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010622e:	e9 32 f4 ff ff       	jmp    80105665 <alltraps>
...
80106235:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010623a:	e9 26 f4 ff ff       	jmp    80105665 <alltraps>
...
80106241:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106246:	e9 1a f4 ff ff       	jmp    80105665 <alltraps>
...
8010624d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106252:	e9 0e f4 ff ff       	jmp    80105665 <alltraps>
...
80106259:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010625e:	e9 02 f4 ff ff       	jmp    80105665 <alltraps>
...
80106265:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010626a:	e9 f6 f3 ff ff       	jmp    80105665 <alltraps>
...
80106271:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106276:	e9 ea f3 ff ff       	jmp    80105665 <alltraps>
...
8010627d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106282:	e9 de f3 ff ff       	jmp    80105665 <alltraps>
...
80106289:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010628e:	e9 d2 f3 ff ff       	jmp    80105665 <alltraps>
...
80106295:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010629a:	e9 c6 f3 ff ff       	jmp    80105665 <alltraps>
...
801062a1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062a6:	e9 ba f3 ff ff       	jmp    80105665 <alltraps>
...
801062ad:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062b2:	e9 ae f3 ff ff       	jmp    80105665 <alltraps>
...
801062b9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062be:	e9 a2 f3 ff ff       	jmp    80105665 <alltraps>
...
801062c5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062ca:	e9 96 f3 ff ff       	jmp    80105665 <alltraps>
...
801062d1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062d6:	e9 8a f3 ff ff       	jmp    80105665 <alltraps>
...
801062dd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062e2:	e9 7e f3 ff ff       	jmp    80105665 <alltraps>
...
801062e9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062ee:	e9 72 f3 ff ff       	jmp    80105665 <alltraps>
...
801062f5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062fa:	e9 66 f3 ff ff       	jmp    80105665 <alltraps>
...
80106301:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106306:	e9 5a f3 ff ff       	jmp    80105665 <alltraps>
...
8010630d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106312:	e9 4e f3 ff ff       	jmp    80105665 <alltraps>
...
80106319:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010631e:	e9 42 f3 ff ff       	jmp    80105665 <alltraps>
...
80106325:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010632a:	e9 36 f3 ff ff       	jmp    80105665 <alltraps>
...
80106331:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106336:	e9 2a f3 ff ff       	jmp    80105665 <alltraps>
...
8010633d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106342:	e9 1e f3 ff ff       	jmp    80105665 <alltraps>
...
80106349:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010634e:	e9 12 f3 ff ff       	jmp    80105665 <alltraps>
...
80106355:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010635a:	e9 06 f3 ff ff       	jmp    80105665 <alltraps>
...
80106361:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106366:	e9 fa f2 ff ff       	jmp    80105665 <alltraps>
...
8010636d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106372:	e9 ee f2 ff ff       	jmp    80105665 <alltraps>
...
80106379:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010637e:	e9 e2 f2 ff ff       	jmp    80105665 <alltraps>
...
80106385:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010638a:	e9 d6 f2 ff ff       	jmp    80105665 <alltraps>
...
80106391:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106396:	e9 ca f2 ff ff       	jmp    80105665 <alltraps>
...
8010639d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063a2:	e9 be f2 ff ff       	jmp    80105665 <alltraps>
...
801063a9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063ae:	e9 b2 f2 ff ff       	jmp    80105665 <alltraps>
...
801063b5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063ba:	e9 a6 f2 ff ff       	jmp    80105665 <alltraps>
...
801063c1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063c6:	e9 9a f2 ff ff       	jmp    80105665 <alltraps>
...
801063cd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063d2:	e9 8e f2 ff ff       	jmp    80105665 <alltraps>
...
801063d9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063de:	e9 82 f2 ff ff       	jmp    80105665 <alltraps>
...
801063e5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063ea:	e9 76 f2 ff ff       	jmp    80105665 <alltraps>
...
801063f1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063f6:	e9 6a f2 ff ff       	jmp    80105665 <alltraps>
...
801063fd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106402:	e9 5e f2 ff ff       	jmp    80105665 <alltraps>
...
80106409:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010640e:	e9 52 f2 ff ff       	jmp    80105665 <alltraps>
...
80106415:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010641a:	e9 46 f2 ff ff       	jmp    80105665 <alltraps>
...
80106421:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106426:	e9 3a f2 ff ff       	jmp    80105665 <alltraps>
...
8010642d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106432:	e9 2e f2 ff ff       	jmp    80105665 <alltraps>
...
80106439:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010643e:	e9 22 f2 ff ff       	jmp    80105665 <alltraps>
...
80106445:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010644a:	e9 16 f2 ff ff       	jmp    80105665 <alltraps>
...
80106451:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106456:	e9 0a f2 ff ff       	jmp    80105665 <alltraps>
...
8010645d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106462:	e9 fe f1 ff ff       	jmp    80105665 <alltraps>
...
80106469:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010646e:	e9 f2 f1 ff ff       	jmp    80105665 <alltraps>
...
80106475:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010647a:	e9 e6 f1 ff ff       	jmp    80105665 <alltraps>
...
80106481:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106486:	e9 da f1 ff ff       	jmp    80105665 <alltraps>
...
8010648d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106492:	e9 ce f1 ff ff       	jmp    80105665 <alltraps>
...
80106499:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010649e:	e9 c2 f1 ff ff       	jmp    80105665 <alltraps>
...
801064a5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064aa:	e9 b6 f1 ff ff       	jmp    80105665 <alltraps>
...
801064b1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064b6:	e9 aa f1 ff ff       	jmp    80105665 <alltraps>
...
801064bd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064c2:	e9 9e f1 ff ff       	jmp    80105665 <alltraps>
...
801064c9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064ce:	e9 92 f1 ff ff       	jmp    80105665 <alltraps>
...
801064d5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064da:	e9 86 f1 ff ff       	jmp    80105665 <alltraps>
...
801064e1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064e6:	e9 7a f1 ff ff       	jmp    80105665 <alltraps>
...
801064ed:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064f2:	e9 6e f1 ff ff       	jmp    80105665 <alltraps>
...
801064f9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064fe:	e9 62 f1 ff ff       	jmp    80105665 <alltraps>
...
80106505:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010650a:	e9 56 f1 ff ff       	jmp    80105665 <alltraps>
...
80106511:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106516:	e9 4a f1 ff ff       	jmp    80105665 <alltraps>
...
8010651d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106522:	e9 3e f1 ff ff       	jmp    80105665 <alltraps>
...
80106529:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010652e:	e9 32 f1 ff ff       	jmp    80105665 <alltraps>
...
80106535:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010653a:	e9 26 f1 ff ff       	jmp    80105665 <alltraps>
...
80106541:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106546:	e9 1a f1 ff ff       	jmp    80105665 <alltraps>
...
8010654d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106552:	e9 0e f1 ff ff       	jmp    80105665 <alltraps>
...
80106559:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010655e:	e9 02 f1 ff ff       	jmp    80105665 <alltraps>
...
80106565:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010656a:	e9 f6 f0 ff ff       	jmp    80105665 <alltraps>
...
80106571:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106576:	e9 ea f0 ff ff       	jmp    80105665 <alltraps>
...
8010657d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106582:	e9 de f0 ff ff       	jmp    80105665 <alltraps>
...
80106589:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010658e:	e9 d2 f0 ff ff       	jmp    80105665 <alltraps>
...
80106595:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010659a:	e9 c6 f0 ff ff       	jmp    80105665 <alltraps>
...
801065a1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065a6:	e9 ba f0 ff ff       	jmp    80105665 <alltraps>
...
801065ad:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065b2:	e9 ae f0 ff ff       	jmp    80105665 <alltraps>
...
8010661a:	e8 51 de ff ff       	call   80104470 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066bd:	68 d0 77 10 80       	push   $0x801077d0
...
80106773:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106776:	e8 45 d0 ff ff       	call   801037c0 <cpuid>
...
80106844:	0f 84 c2 00 00 00    	je     8010690c <switchuvm+0xec>
  pushcli();
8010684a:	e8 41 da ff ff       	call   80104290 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010684f:	e8 ec ce ff ff       	call   80103740 <mycpu>
80106854:	89 c6                	mov    %eax,%esi
80106856:	e8 e5 ce ff ff       	call   80103740 <mycpu>
8010685b:	89 c7                	mov    %eax,%edi
8010685d:	e8 de ce ff ff       	call   80103740 <mycpu>
80106862:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106865:	83 c7 08             	add    $0x8,%edi
80106868:	e8 d3 ce ff ff       	call   80103740 <mycpu>
...
8010695f:	e8 0c db ff ff       	call   80104470 <memset>
...
80106990:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106991:	e9 8a db ff ff       	jmp    80104520 <memmove>
    panic("inituvm: more than a page");
80106996:	83 ec 0c             	sub    $0xc,%esp
80106999:	68 15 78 10 80       	push   $0x80107815
...
80106abb:	e8 b0 d9 ff ff       	call   80104470 <memset>
...
80106afd:	68 4d 78 10 80       	push   $0x8010784d
...
80106b33:	68 65 78 10 80       	push   $0x80107865
...
80106c3c:	68 81 78 10 80       	push   $0x80107881
...
80106c70:	e8 fb d7 ff ff       	call   80104470 <memset>
...
80106d0f:	68 92 78 10 80       	push   $0x80107892
...
80106d60:	e8 bb d7 ff ff       	call   80104520 <memmove>
...
80106df9:	68 b6 78 10 80       	push   $0x801078b6
80106dfe:	e8 8d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e03:	83 ec 0c             	sub    $0xc,%esp
80106e06:	68 9c 78 10 80       	push   $0x8010789c
...
80106e8f:	e8 8c d6 ff ff       	call   80104520 <memmove>
    len -= n;
    buf += n;
